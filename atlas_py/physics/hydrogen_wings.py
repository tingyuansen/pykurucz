"""Hydrogen wing opacity following the Kurucz HLINOP routine (atlas_py copy of synthe_py)."""
...
from .hydrogen_wings_data import load_hydrogen_wings_tables as _load_hw_tables
...
_HW_TABLES = _load_hw_tables()
KNMTAB = _HW_TABLES["KNMTAB"]
FSTARK = _HW_TABLES["FSTARK"]
...
HIGH_LEVEL_TERMS_ARRAY = _HW_TABLES["HIGH_LEVEL_TERMS_ARRAY"]
LOW_LEVEL_TERMS_ARRAY = _HW_TABLES["LOW_LEVEL_TERMS_ARRAY"]
